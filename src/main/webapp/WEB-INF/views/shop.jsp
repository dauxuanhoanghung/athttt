...
<body>
	...
	<!--	<c:forEach items="${products}"  var="product">	<p>${product.name}</p>
	</c:forEach>-->
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-9">
					...
					<div class="row container_shop_product">
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="product__pagination">
								<a href="?page=1" class="active" href="#">1</a> <a
									href="?page=2" class="page-2">2</a> <a href="#">3</a> <span>...</span>
								<a href="#">21</a>
							</div>
						</div>
					</div>
	...
	<script type="module" src="./handleEvent/ShopEvent.js"></script>
	<script type="module" src="./utils/callAPI.js"></script>
	<script type="module" src="./utils/queryElement.js"></script>
	<script type="module" src="./service/productService.js"></script>
	<script type="module" src="./service/categoryService.js"></script>
</body>
</html>
